...
export const SITE = {
  name: '78OK 娛樂城',
  brand: '78OK',
  url: 'https://78ok.com.tw',
  blogTitle: '78OK 娛樂誌',
  blogDesc: '78OK 娛樂城官方部落格：平台指南、註冊與帳號、APP與手機版、優惠活動、存款與出金、遊戲玩法、安全查核、客服與常見問題，手把手教你玩得安心、領好領滿。',
  lang: 'zh-Hant-TW',
  ...
  // 官方 LINE 客服（換站時改這裡）
  lineId: '@768awkvi',
  lineUrl: 'https://line.me/R/ti/p/@768awkvi',
  // 版權年份
  year: 2026,
};
...
// slug 為固定英文（URL Standard v2.1），網址 = 根層 /{slug}
...
export const CATEGORY_INTRO: Record<string, string> = {
  'platform': '第一次玩 78OK？這裡帶你認識平台怎麼運作、有哪些遊戲與服務、新手該從哪裡開始。看完就能快速上手，知道每個功能在哪、怎麼用。',
  ...
  'promotions': '新會員 88 體驗金、每日簽到、首儲連續 3 天最高領 200%、每日返水、這裡教你把 78OK 的優惠領好領滿，並看懂流水（打碼量）規則，避免領了卻用不到。',
  ...
  'security': '這家平台可不可信？怎麼辨識官方入口與仿冒／黑網？這裡教你確認平台合法性、保護資料交易安全、評估平台信用，玩得安心不踩雷。',
...
export const CATEGORY_HUBS: Record<string, { label: string; href: string; desc: string }[]> = {
  'deposit-withdraw': [
    ...
    { label: '出金／提款問題總整理', href: '/withdraw-guide/', desc: '出金流程、提款時間、流水件件與提款延遲、銀行攔截處理。' },
  ],
};

// ---- 根層保留字（reservedSlugSet）：URL Standard v2.1 §7.7 ----
